                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-kota_lahir"> Kota Lahir</th>
                                                ...
                                                <th  class="td-jenis_karyawan"> Jenis Karyawan</th>
                                                <th  class="td-divisi_id"> Divisi Id</th>
                                                <th  class="td-jabatan_id"> Jabatan Id</th>
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-pendidikan">
                                                        <span  data-value="<?php echo $data['pendidikan']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                    ...
                                                    <td class="td-kota_lahir">
                                                        <span  data-value="<?php echo $data['kota_lahir']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="kota_lahir" 
                                                            data-title="Enter Kota Lahir" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                            data-showbuttons="left" 
                                                            class="is-editable" >
                                                            <?php echo $data['kota_lahir']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-tgl_lahir">
                                                        <span  data-value="<?php echo $data['tgl_lahir']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="tgl_lahir" 
                                                    ...
                                                    <td class="td-tgl_masuk">
                                                        <span  data-value="<?php echo $data['tgl_masuk']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="tgl_masuk" 
                                                    ...
                                                    <td class="td-jenis_karyawan">
                                                        <span  data-value="<?php echo $data['jenis_karyawan']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="jenis_karyawan" 
                                                            data-title="Enter Jenis Karyawan" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
                                                            data-mode="popover" 
                                                            data-showbuttons="left" 
                                                            class="is-editable" >
                                                            <?php echo $data['jenis_karyawan']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-divisi_id">
                                                        <span  data-value="<?php echo $data['divisi_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="divisi_id" 
                                                            data-title="Enter Divisi Id" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
                                                            data-showbuttons="left" 
                                                            class="is-editable" >
                                                            <?php echo $data['divisi_id']; ?> 
                                                        </span>
                                                    </td>
                                                    <td class="td-jabatan_id">
                                                        <span  data-value="<?php echo $data['jabatan_id']; ?>" 
                                                            data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("users/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="jabatan_id" 
                                                            data-title="Enter Jabatan Id" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="number" 
                                                            data-mode="popover" 
