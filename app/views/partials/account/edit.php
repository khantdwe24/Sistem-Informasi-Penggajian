                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-kota_lahir"  value="<?php  echo $data['kota_lahir']; ?>" type="text" placeholder="Enter Kota Lahir"  required="" name="kota_lahir"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-tgl_lahir"  value="<?php  echo $data['tgl_lahir']; ?>" type="text" placeholder="Enter Tgl Lahir"  required="" name="tgl_lahir"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <input id="ctrl-tgl_masuk"  value="<?php  echo $data['tgl_masuk']; ?>" type="text" placeholder="Enter Tgl Masuk"  required="" name="tgl_masuk"  class="form-control " />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <div class="form-group ">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-sm-8">
                                                                                    <div class="">
                                                                                        <input id="ctrl-jenis_karyawan"  value="<?php  echo $data['jenis_karyawan']; ?>" type="text" placeholder="Enter Jenis Karyawan"  required="" name="jenis_karyawan"  class="form-control " />
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group ">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-sm-8">
                                                                                        <div class="">
                                                                                            <input id="ctrl-divisi_id"  value="<?php  echo $data['divisi_id']; ?>" type="number" placeholder="Enter Divisi Id" step="1"  required="" name="divisi_id"  class="form-control " />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="form-group ">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-8">
                                                                                            <div class="">
                                                                                                <input id="ctrl-jabatan_id"  value="<?php  echo $data['jabatan_id']; ?>" type="number" placeholder="Enter Jabatan Id" step="1"  required="" name="jabatan_id"  class="form-control " />
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
