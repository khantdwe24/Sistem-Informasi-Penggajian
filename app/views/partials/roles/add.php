                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-guard_name"  value="<?php  echo $this->set_field_value('guard_name',""); ?>" type="text" placeholder="Enter Guard Name"  required="" name="guard_name"  class="form-control " />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
