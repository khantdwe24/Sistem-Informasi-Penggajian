...
class UsersController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				users.image LIKE ? OR 
				users.nip LIKE ? OR 
				users.pendidikan LIKE ? OR 
				users.kota_lahir LIKE ? OR 
				users.tgl_lahir LIKE ? OR 
				users.tgl_masuk LIKE ? OR 
				users.jk LIKE ? OR 
				users.agama LIKE ? OR 
				users.status LIKE ? OR 
				users.alamat LIKE ? OR 
				users.jenis_karyawan LIKE ? OR 
				users.divisi_id LIKE ? OR 
				users.jabatan_id LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("name","email","password","image","nip","pendidikan","kota_lahir","tgl_lahir","tgl_masuk","jk","agama","status","alamat","jenis_karyawan","divisi_id","jabatan_id","remember_token","created_at","updated_at");
			...
			$this->sanitize_array = array(
				...
				'jenis_karyawan' => 'sanitize_string',
				'divisi_id' => 'sanitize_string',
				'jabatan_id' => 'sanitize_string',
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","name","image","nip","pendidikan","kota_lahir","tgl_lahir","tgl_masuk","jk","agama","status","alamat","jenis_karyawan","divisi_id","jabatan_id","remember_token","created_at","updated_at");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'name' => 'required',
