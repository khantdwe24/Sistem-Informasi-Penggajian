...
class IndexController extends BaseController{
	...
	function register($formdata = null){
		if($formdata){
			...
			$db = $this->GetModel();
			$tablename = $this->tablename;
			$fields = $this->fields = array("name","email","password","image","nip","pendidikan","kota_lahir","tgl_lahir","tgl_masuk","jk","agama","status","alamat","jenis_karyawan","divisi_id","jabatan_id","remember_token"); //registration fields
